...
async function main() {
    ...
    console.log("we are connecting to a test network via the rfc6455 protocol + secure...") 
    console.log("the rfc6455 protocol is a websocket protocol that allows for two way communication between a client and an UNKNOWN server")
    console.log("the secure part is the wss:// which means that the connection is encrypted")
    console.log("\n network: testnet")
    console.log("protocol: rfc6455")
    console.log("secure: wss://")
    console.log("port: 51233")
    console.log("server: s.altnet.rippletest.net")
    console.log("client: is whatever computer you are using to run this code")
